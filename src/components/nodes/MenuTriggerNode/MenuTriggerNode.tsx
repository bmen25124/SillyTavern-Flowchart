...
import { MenuTriggerNodeData } from './definition.js';
import { BaseNode } from '../BaseNode.js';
import { STInput } from 'sillytavern-utils-lib/components';
import { NodeHandleRenderer } from '../NodeHandleRenderer.js';
import { registrator } from '../autogen-imports.js';

export type MenuTriggerNodeProps = NodeProps<Node<MenuTriggerNodeData>>;

export const MenuTriggerNode: FC<MenuTriggerNodeProps> = ({ id, selected, type }) => {
  const data = useFlowStore((state) => state.nodesMap.get(id)?.data) as MenuTriggerNodeData;
  ...
  return (
    <BaseNode id={id} title="Menu Button Trigger" selected={selected}>
