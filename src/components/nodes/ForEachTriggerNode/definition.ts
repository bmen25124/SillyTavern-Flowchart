...
export const forEachTriggerNodeDefinition: NodeDefinition<ForEachTriggerNodeData> = {
  ...
  handles: {
    ...
    outputs: [
      ...
      { id: 'array', type: FlowDataType.ARRAY, label: 'Array' },
      { id: 'length', type: FlowDataType.NUMBER, label: 'Length' },
      { id: 'remainingItems', type: FlowDataType.ARRAY, label: 'Remaining Items' },
    ],
  },
  execute,
